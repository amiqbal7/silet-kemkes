...
const LinkTerkait = () => {
  ...
  return (
    <div className="lg:mx-20 mx-5 pt-20 pb-28" name="LinkTerkait">
      <div className="bg-sky-200 text-center py-10 lg:flex rounded-md shadow-lg">
        ...
        <div className="w-full lg:mx-auto px-7 justify-items-center grid sm:grid-cols-2 xl:grid-cols-4 gap-5">
          <div
            ...
            className={`gap-4 justify-center bg-[#3c8eba] h-[300px] hover:bg-sky-700 hover:text-white px-4 rounded-lg shadow-lg w-full mx-10 md:mx-0 relative ${
          ...
          <div
            ...
            onMouseLeave={handleMouseLeave}
            className={`gap-4 bg-[#3c8eba] h-[300px] px-4 rounded-lg shadow-lg w-full mx-10 md:mx-0 relative ${
          ...
          >
            ...
            <div>
              ...
              <p className="text-slate-100">Pendaftaran Peserta Bantuan PPDS/PPDGS</p>
            </div>
            {hoveredIndex === 3 && (
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 mb-[-20px]">
                <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
